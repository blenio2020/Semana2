...
var contenido = document.querySelector('#mensajes')
        function traer() {
            ...
            .then(data => {
                ...
                document.getElementById("listaMensajes").insertRow(-1).innerHTML = `<td>${objetoTemporal.nombre.last}</td><td>${objetoTemporal.telefono}</td><td>${objetoTemporal.mensaje}, Saludos</td>`      
            })
        } 